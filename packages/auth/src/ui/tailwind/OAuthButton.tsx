...
export function OAuthButton({ provider, label, disabled }: OAuthButtonProps) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className="flex items-center justify-center gap-2 w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
    >
      {config.icon}
      {label ?? config.label}
    </button>
